...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7654652081:AAF9eWDqPb02kx5-iZtNUT7SH3RN6eSga9E") 
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001680462545"))
...
ADMINS = os.environ.get("ADMINS", "5709856741").split()
